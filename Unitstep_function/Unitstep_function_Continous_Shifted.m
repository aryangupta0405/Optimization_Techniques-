...
t1=-5:0.1:-2; %creating vector from -5 to 0 with 0.1 uits space
t2=-2:0.1:5;  %creating vector from 0 to 5 with 0.1 uits space
...
xlabel('t')
ylabel('u(t)')
title('Continous Unit Step Function shifted-Aryan Gupta 102056002')
